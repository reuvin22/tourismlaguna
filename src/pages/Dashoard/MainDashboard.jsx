  ...
  return (
    ...
    {loading ? <Loading /> :
            <div className='flex justify-center relative'>
                <div className={`${open ? 'visible' : 'hidden'} z-10 absolute left-0`}>
                ...
                <div className={`${open ? 'hidden' : 'visible'}`}>
                  ...
                  >
                    <img src='https://firebasestorage.googleapis.com/v0/b/projectimages-a2f47.appspot.com/o/image-removebg-preview%20(5).png?alt=media&token=e87a188b-4123-4845-85cf-2c9436f89753' className='w-10 h-10 absolute ml-10 cursor-pointer'/>
                  </button>
                </div>
                    ...
                    <div className='gap-3 flex justify-end w-full'>
                        ...
                        <div className='flex justify-center item-center relative mr-10'>
                            ...
                            <div className='grid place-items-center'>
                                <button
                                onClick={()=> handleOpen()}
                                    ><img src="https://firebasestorage.googleapis.com/v0/b/projectimages-a2f47.appspot.com/o/arrowDown.png?alt=media&token=9249b8aa-1b8e-4e37-99aa-3d069ce9e75a" alt="Accordion" className='h-5 w-5 ml-10' /></button>
                                <div className={`${dropdown ? 'visible absolute mt-28 bg-slate-300 w-36' : 'hidden'}`}>
                                    <Dropdown
                                        btnName="Setting"
                                    />
                                    <Dropdown
